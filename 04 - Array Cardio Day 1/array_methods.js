...
const fullNames = inventors.map((el) => `${el.first} ${el.last}`);
...
const totalLifespan = inventors.reduce((acc, curr) => acc + curr.passed - curr.year, 0);
console.log(totalLifespan);

// 5. Sort the inventors by years lived
const sortedByLifespan = inventors.sort((a, b) => b.passed - b.year - (a.passed - a.year));
